  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Formulario Oficial Didáctico — Unidad N° 1"
        tabIndex={-1}
        onClick={(e) => e.stopPropagation()}
        className="relative bg-white dark:bg-[#0F172A] w-full max-w-4xl rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden max-h-[92vh] flex flex-col outline-none"
      >
        {/* Header */}
        <div className="bg-[#0F2942] dark:bg-[#080D1A] p-4 sm:p-5 text-white flex items-center justify-between gap-4 flex-shrink-0 border-b border-[#1C4874] dark:border-slate-800">
          ...
          <button
            type="button"
            onClick={onClose}
            aria-label="Cerrar glosario de fórmulas"
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-6 text-slate-800 dark:text-slate-200 text-sm">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Diferencia entre valor extremo superior e inferior.</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Redondeo al entero más próximo o superior.</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Ancho uniforme de cada intervalo.</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Punto medio representativo de la clase.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Proporción de fa respecto a n (Suma total = 1,00).</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Expresión porcentual (Suma total = 100,00%).</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Suma progresiva de observaciones acumuladas.</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Proporción acumulada de observaciones.</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Porcentaje acumulado (Última fila = 100,00%).</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Cantidad total de observaciones relevadas.</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1.5">El numerador <strong>está incluido</strong> en el denominador. Rango: de \(0\) a \(1\) (ó \(0\%\) a \(100\%\)).</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1.5">Compara dos grupos independientes. El numerador <strong>NO</strong> está en el denominador (ej. 50 operarios por técnico).</p>
              </div>
              ...
              <div className="min-w-0 bg-slate-50 dark:bg-[#131C2E] p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <p className="text-xs text-slate-600 dark:text-slate-400 mt-1.5">Velocidad de ocurrencia en el tiempo escalada con la constante \(K\) (\(1.000\) o \(1.000.000\)).</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="min-w-0 bg-emerald-50/50 dark:bg-emerald-950/20 p-3.5 rounded-xl border border-emerald-200 dark:border-emerald-900/40 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-xs font-bold text-[#0F2942] dark:text-slate-100">1. Índice de Frecuencia (IF)</span>
                  <span className="text-[11px] font-bold text-emerald-700 dark:text-emerald-400 bg-white dark:bg-[#0A1322] px-2 py-0.5 rounded border border-emerald-200 dark:border-emerald-800 flex-shrink-0">Base 1.000.000 hs</span>
                </div>
                <div className="font-mono text-xs text-[#1B8A5A] dark:text-emerald-300 bg-white dark:bg-[#0A1322] p-2 rounded border border-emerald-200 dark:border-emerald-800 overflow-x-auto">
                  <MathFormula formula="IF = \frac{\text{N° Accidentes con Baja} \cdot 1.000.000}{\text{Horas-Hombre Trabajadas (HHT)}}" />
                </div>
                <p className="text-xs text-slate-600 dark:text-slate-400">Accidentes con baja médica ocurridos por cada millón de horas persona trabajadas. (k = 1.000.000; para PyME se admite k = 1.000)</p>
              </div>

              <div className="min-w-0 bg-amber-50/50 dark:bg-amber-950/20 p-3.5 rounded-xl border border-amber-200 dark:border-amber-900/40 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-xs font-bold text-[#0F2942] dark:text-slate-100">2. Índice de Gravedad (IG)</span>
                  <span className="text-[11px] font-bold text-amber-700 dark:text-amber-400 bg-white dark:bg-[#0A1322] px-2 py-0.5 rounded border border-amber-200 dark:border-amber-800 flex-shrink-0">Base 1.000.000 hs</span>
                </div>
                <div className="font-mono text-xs text-[#E67E22] dark:text-amber-400 bg-white dark:bg-[#0A1322] p-2 rounded border border-amber-200 dark:border-amber-800 overflow-x-auto">
                  <MathFormula formula="IG = \frac{\text{Total Días Perdidos} \cdot 1.000.000}{\text{Horas-Hombre Trabajadas (HHT)}}" />
                </div>
                <p className="text-xs text-slate-600 dark:text-slate-400">Jornadas de trabajo no trabajadas por cada millón de horas persona trabajadas. (k = 1.000.000; para PyME se admite k = 1.000)</p>
              </div>

              <div className="min-w-0 bg-blue-50/50 dark:bg-blue-950/20 p-3.5 rounded-xl border border-blue-200 dark:border-blue-900/40 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-xs font-bold text-[#0F2942] dark:text-slate-100">3. Índice de Incidencia (II)</span>
                  <span className="text-[11px] font-bold text-blue-700 dark:text-blue-400 bg-white dark:bg-[#0A1322] px-2 py-0.5 rounded border border-blue-200 dark:border-blue-800 flex-shrink-0">Base 1.000 trab.</span>
                </div>
                <div className="font-mono text-xs text-blue-700 dark:text-blue-300 bg-white dark:bg-[#0A1322] p-2 rounded border border-blue-200 dark:border-blue-800 overflow-x-auto">
                  <MathFormula formula="II = \frac{\text{N° Accidentes con Baja} \cdot 1.000}{\text{N° Promedio Trabajadores Expuestos}}" />
                </div>
                <p className="text-xs text-slate-600 dark:text-slate-400">Accidentes con baja ocurridos por cada mil trabajadores en la nómina.</p>
              </div>

              <div className="min-w-0 bg-purple-50/50 dark:bg-purple-950/20 p-3.5 rounded-xl border border-purple-200 dark:border-purple-900/40 space-y-2">
                <div className="flex items-center justify-between gap-2">
                  <span className="text-xs font-bold text-[#0F2942] dark:text-slate-100">4. Duración Media (DM)</span>
                  <span className="text-[11px] font-bold text-purple-700 dark:text-purple-400 bg-white dark:bg-[#0A1322] px-2 py-0.5 rounded border border-purple-200 dark:border-purple-800 flex-shrink-0">Días por accidente</span>
                </div>
                <div className="font-mono text-xs text-purple-700 dark:text-purple-300 bg-white dark:bg-[#0A1322] p-2 rounded border border-purple-200 dark:border-purple-800 overflow-x-auto">
                  <MathFormula formula="DM = \frac{\text{Total Días Perdidos}}{\text{N° Accidentes con Baja}}" />
                </div>
                <p className="text-xs text-slate-600 dark:text-slate-400">Promedio de días de reposo o baja médica por cada accidente ocurrido.</p>
              </div>
            </div>

            {/* Relación de coherencia */}
            <div className="p-3 bg-slate-100 dark:bg-[#0A1322] rounded-xl border border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <div className="font-mono text-xs font-bold text-[#1B8A5A] dark:text-emerald-400 bg-white dark:bg-[#131C2E] px-3 py-1 rounded border border-slate-200 dark:border-slate-700 overflow-x-auto">
